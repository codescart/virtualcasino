...
class selectpopup extends StatefulWidget {
  ...
  final color1;
  final number;
  selectpopup({required this.color, this.number, this.color1, });
  @override
          ...
          children: [
            Container(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    Text('Select',style: TextStyle(fontWeight: FontWeight.w400,fontSize: 22,color: Colors.white),),
                    SizedBox(width: 2.w,),
                    Text( widget.number,style: TextStyle(fontWeight: FontWeight.w400,fontSize: 22,color: Colors.white),),
                  ],
                ),
              ),
